...
const HeaderRow = createReactClass({
  ...
  getSortableHeaderCell(column) {
    ...
    if (React.isValidElement(Renderer)) {
      ...
      if (typeof SortableRenderer.type === 'string') {
        ...
        return <SortableRenderer columnKey={column.key} onSort={this.props.onSort} sortDirection={sortDirection}/>;
      }
    }
  },
  ...
  getHeaderRenderer(column) {
    let renderer;
    if (column.headerRenderer && !this.props.filterable && !this.props.sortable) {
